...
const files = ['index.html','styles.css','core.js','app.js','data/context.js','data/context.json','data/plan.js','docs/DESIGN.md'];
...
console.log('Static site built with actual OSM/DEM context and eight station exports.');
