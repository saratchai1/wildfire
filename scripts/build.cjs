...
const files=['bayes-engine.js','bayes-worker.js','bayes-panel.js','bayes.css','v2a-simulator.js','docs/V2A_BAYESIAN.md','index.html','forward.html','planning.html','v1.html','inverse-engine.js','inverse-worker.js','inverse-simulator.js','inverse-ui.js','inverse.css','console.css','console-model.js','console-map.js','console.js','styles.css','core.js','core-v1.js','app.js','app-v1.js','history.js','history.css','siting.js','siting-ui.js','siting.css','data/context.js','data/context.json','data/plan.js','data/plan-v2.json','data/plan-v1.js','data/plan-v1-compare.js','docs/DESIGN.md','docs/DESIGN_V2.md','docs/LEGACY_REFERENCE.md','docs/OPERATOR_EXPLAINER.md','docs/NORTH_STATION.md','docs/INVERSE_SOURCE.md','docs/REVIEW_FIXES.md'];
